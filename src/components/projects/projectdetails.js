...
class ProjectDetails extends React.Component {
  ...
  render() {
    return (
      <div>
        {this.state.zoomed === -1 ? (
          <div className={layoutStyles.sideButton} onClick={this.props.onExit}>
            Return to Projects
          </div>
        ) : (
          <div
        ...
        {this.state.zoomed === -1 ? (
          <div className={animations.slideEnter}>
            {this.maxSlides !== 0 && (
              <Slider className={styles.slider} {...this.carouselSettings}>
                {this.props.images.map((image, index) => (
                  ...
                  >
                    ...
                    />
                    <div className={styles.sliderImageOverlay} />
                  </div>
                ))}
              </Slider>
            )}
          ...
          <div>
            <Img
              className={`${styles.sliderImage} ${animations.slideEnter}`}
              sizes={
                this.props.images[this.state.zoomed].node.childImageSharp.sizes
              }
            />
          </div>
        )}

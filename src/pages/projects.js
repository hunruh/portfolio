...
class ProjectsPage extends React.Component {
  ...
  componentDidMount() {
    this.animationUpdater = setInterval(() => this.advanceAnimationStep(), 150)
  }
        ...
        return (
          <div className={styles.projects}>
            <ProjectTile
              ...
              thumbnailSizes={
                data.trinoImages.edges[0].node.childImageSharp.sizes
              }
              onClick={() => this.setState({ selectedProject: 'trino' })}
